...
function createFilterItemTemplate(filter, currentFilterType) {
  ...
  return (
    `<div class="trip-filters__filter"><input id="filter-${type}" class="trip-filters__filter-input  visually-hidden" type="radio" name="trip-filter" value="${type}" ${currentFilterType === type ? 'checked' : ''} ${count === 0 ? 'disabled' : ''}>
